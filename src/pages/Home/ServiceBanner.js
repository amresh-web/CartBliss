...
const ServiceBanner = () => {
  return (
    <>
      <article>
        <div className={[styles.service_banner].join(" ")}>
          <h2 className={"text-center pb-5"}>
            Why shop <span className={"text-white"}>with us</span>
          </h2>
          <div className={"d-flex flex-row"}>
            {services.map((service) => (
              <div
                key={service.id}
                className={["flex-grow-1 text-center"].join(" ")}
              >
      ...
      <article>
        <div className={styles.weoffer}>
          <div className={styles.offergrid}>
            <div className={["bg-white text-center py-5"].join(" ")}>
              <div className={"flex justify-content-center"}>
                <svg
                  aria-hidden="true"
                  focusable="false"
                  ...
                  viewBox="0 0 536 512"
                  className="svg-inline--fa fa-star-half-alt fa-w-17 fa-3x"
                >
                  <defs>
                    {" "}
                    <linearGradient
                    ...
                    >
                      {" "}
                      <stop offset="0%" stopColor="#6423d1">
                        {" "}
                      </stop>{" "}
                      <stop offset="100%" stopColor="#a215e1">
                        {" "}
                      </stop>{" "}
                    </linearGradient>{" "}
                  </defs>
            ...
            <div className={["bg-white text-center py-5"].join(" ")}>
              <div className={"flex justify-content-center"}>
                <svg
                  ...
                  xmlns="http://www.w3.org/2000/svg"
                  viewBox="0 0 640 512"
                  className="svg-inline--fa fa-warehouse fa-w-20 fa-3x"
                >
                  <defs>
                    <linearGradient
                      id="logo-gradient"
            ...
            <div className={["bg-white text-center py-5"].join(" ")}>
              <div className={"flex justify-content-center"}>
                <svg
                  ...
                  xmlns="http://www.w3.org/2000/svg"
                  viewBox="0 0 512 512"
                  className="svg-inline--fa fa-shield-alt fa-w-16 fa-3x"
                >
                  <defs>
                    <linearGradient
                      id="logo-gradient"
            ...
            <div className={["bg-white text-center py-5"].join(" ")}>
              <div className={"flex justify-content-center"}>
                <svg
                  ...
                  xmlns="http://www.w3.org/2000/svg"
                  viewBox="0 0 512 512"
                  className="svg-inline--fa fa-question-circle fa-w-16 fa-3x"
                >
                  <defs>
                    <linearGradient
                      id="logo-gradient"
